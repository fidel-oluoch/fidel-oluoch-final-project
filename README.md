...
<html lang="en">
 ...
 <body>
         ...
         <section class="Cards">
           <div class="containerA">
             <div class="textA">
               ...
               <p>Compare costs to ensure that the company provides good value for money without hidden fees. Discounts, scholarships, or membership benefits are a plus</p>
             </div>
             <div class="imageA">
   ...
   <script>
     ...
     updateStarRatings();# fidel-oluoch-final-project
